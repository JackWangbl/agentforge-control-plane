...
def seed_database(db: Session) -> None:
    ...
    db.add_all([
        ...
        SandboxPolicy(name="标准 Python 沙箱", runtime="docker:python:3.11-slim", cpu_limit="1 vCPU", memory_limit="1 GiB", timeout_seconds=60, network_mode="deny"),
        SandboxPolicy(name="高隔离代码执行", runtime="docker:python:3.12-slim", cpu_limit="2 vCPU", memory_limit="2 GiB", timeout_seconds=120, network_mode="deny"),
